...
class PlatformRepository(Protocol):
    def list_interface_datasets(self, project_id: str, scenario_id: str) -> list[dict[str, Any]]: ...
    def save_interface_dataset(self, project_id: str, scenario_id: str, name: str, content: str, format_name: str, actor: str) -> dict[str, Any]: ...
    def delete_interface_dataset(self, project_id: str, dataset_id: str) -> bool: ...
    def enqueue_interface_dataset(self, project_id: str, scenario_id: str, dataset_id: str, actor: str, concurrency: int = 3) -> dict[str, Any]: ...
    def list_interface_schedules(self, project_id: str, scenario_id: str) -> list[dict[str, Any]]: ...
    def save_interface_schedule(self, project_id: str, scenario_id: str, dataset_id: str, interval_seconds: int, concurrency: int, actor: str) -> dict[str, Any]: ...
    def change_interface_schedule(self, project_id: str, identifier: str, enabled: bool | None, actor: str) -> bool: ...
    def dispatch_interface_schedule(self, *, now: float | None = None) -> dict[str, Any] | None: ...
    def interface_scenario_trend(self, project_id: str, scenario_id: str, limit: int = 50) -> dict[str, Any]: ...
